...
const Switch = React.forwardRef<HTMLButtonElement, SwitchProps>(
  ({ className, pressed, onPressedChange, disabled, ...props }, ref) => (
    <button
      type="button"
      ref={ref}
      role="switch"
    ...
    >
      <span
        className={cn(
          "pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform absolute left-0.5",
